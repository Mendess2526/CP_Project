...
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{movel}\mathrel{=}\map \;(\lambda \Varid{h}\to \Conid{Rotate}\;\mathrm{45}\;(\Conid{Translate}\;(\mathbin{-}((\Varid{width}\;\Varid{a})\mathbin{/}\mathrm{2.0}))\;(\Varid{sqrt}\;((\Varid{width}\;\Varid{h})\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2})\;\Varid{h})){}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{mover}\mathrel{=}\map \;(\lambda \Varid{h}\to \Conid{Rotate}\;\mathrm{45}\;(\Conid{Translate}\;({}\<[60]%
\>[60]{}(\Varid{width}\;\Varid{a})\mathbin{/}\mathrm{2.0})\;{}\<[78]%
\>[78]{}(\Varid{sqrt}\;((\Varid{width}\;\Varid{h})\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2})\;\Varid{h})){}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{width}\;(\Conid{Polygon}\;(\anonymous \mathbin{:}\Varid{side}\mathbin{:}\Varid{t}))\mathrel{=}(\p1\;\Varid{side})\mathbin{+}(\p2\;\Varid{side}){}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
