...
\\[\blanklineskip]%
\>[B]{}\Varid{normL}\;((\Varid{e},\Varid{v}),[\mskip1.5mu \mskip1.5mu]){}\<[30]%
\>[30]{}\mathrel{=}[\mskip1.5mu (\Varid{e},\Varid{v})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{normL}\;((\Varid{e},\Varid{v}),((\Varid{el},\Varid{vl})\mathbin{:}\Varid{tl}))\mid \Varid{e}\equiv \Varid{el}{}\<[42]%
\>[42]{}\mathrel{=}(\Varid{el},\Varid{v}\mathbin{+}\Varid{vl})\mathbin{:}\Varid{tl}{}\<[E]%
\\
\>[B]{}\hsindent{30}{}\<[30]%
\>[30]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{el},\Varid{vl})\mathbin{:}(\Varid{normL}\;((\Varid{e},\Varid{v}),\Varid{tl})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{normalizeL}\mathrel{=}\Varid{cataList}\;\alt{\Varid{nil}}{\Varid{normL}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{t2l}\;(\Varid{f},(\Varid{v},\Varid{t}))\mathrel{=}[\mskip1.5mu (\Varid{f},\mathbin{-}\Varid{v}),(\Varid{t},\Varid{v})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{ledger}\mathrel{=}\Varid{normalizeL}\comp (\Varid{cataList}\;\alt{\Varid{nil}}{\mathsf{conc}\comp (\Varid{t2l}\times\Varid{id})})\comp \Varid{allTransactions}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{bloco1}\mathrel{=}\Conid{Bc}\;(\text{\ttfamily \char34 123\char34},(\mathrm{1234},[\mskip1.5mu \mskip1.5mu])){}\<[E]%
\\
\>[B]{}\Varid{bloco2}\mathrel{=}\Conid{Bc}\;(\text{\ttfamily \char34 124\char34},(\mathrm{12},[\mskip1.5mu (\text{\ttfamily \char34 Eu\char34},(\mathrm{70},\text{\ttfamily \char34 Bruno\char34}))\mskip1.5mu])){}\<[E]%
\\
\>[B]{}\Varid{blocolista}\mathrel{=}\Conid{Bcs}\;((\Varid{bc}\;\Varid{bloco1}),{}\<[33]%
\>[33]{}\Varid{bloco2}){}\<[E]%
\\
\>[B]{}\Varid{blocoFDD}\mathrel{=}\Conid{Bcs}\;((\text{\ttfamily \char34 123\char34},(\mathrm{12},[\mskip1.5mu (\text{\ttfamily \char34 Bruno\char34},(\mathrm{10},\text{\ttfamily \char34 Fil\char34}))\mskip1.5mu])),\Varid{blocolista}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{flipCell}}{\Varid{flipTrees}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{3}{}\<[8]%
\>[8]{}\Varid{flipCell}\mathrel{=}\Varid{cell}\comp (\Varid{id}\times\Varid{swap}){}\<[E]%
\\
\>[5]{}\hsindent{3}{}\<[8]%
\>[8]{}\Varid{flipTrees}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}\Conid{Block}\;\Varid{c}\;\Varid{a}\;\Varid{d}\;\Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{scaleQTree}\;\Varid{s}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{scaleCell}}{\Varid{block}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{compressQTree}\;\Varid{n}\;\Varid{t}\mathrel{=}\Varid{seek}\;((\Varid{depthQTree}\;\Varid{t})\mathbin{-}\Varid{n})\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{seek}\;\Varid{n}\;\Varid{t}\mid \Varid{n}\mathbin{<}\mathrm{1}{}\<[32]%
\>[32]{}\mathrel{=}\Varid{cell}\;(\Varid{destroy}\;\Varid{t}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{seek}\;\Varid{n}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}){}\<[32]%
\>[32]{}\mathrel{=}(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{seek}\;\Varid{n}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}\Conid{Block}\;(\Varid{seek}\;(\Varid{n}\mathbin{-}\mathrm{1})\;\Varid{a})\;(\Varid{seek}\;(\Varid{n}\mathbin{-}\mathrm{1})\;\Varid{b})\;(\Varid{seek}\;(\Varid{n}\mathbin{-}\mathrm{1})\;\Varid{c})\;(\Varid{seek}\;(\Varid{n}\mathbin{-}\mathrm{1})\;\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{destroy}\mathbin{::}\Conid{QTree}\;\Varid{a}\to (\Varid{a},(\Conid{Int},\Conid{Int})){}\<[E]%
\\
\>[B]{}\Varid{destroy}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{id}}{\Varid{avgPixel2}\comp \Varid{pair2list}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avgPixel}\mathbin{::}((\Varid{a},(\Conid{Int},\Conid{Int})),((\Varid{a},(\Conid{Int},\Conid{Int})),((\Varid{a},(\Conid{Int},\Conid{Int})),((\Varid{a},(\Conid{Int},\Conid{Int}))))))\to (\Varid{a},(\Conid{Int},\Conid{Int})){}\<[E]%
\\
\>[B]{}\Varid{avgPixel}\;((\Varid{a},(\Varid{x1},\Varid{y1})),((\Varid{b},\anonymous ),((\Varid{c},(\anonymous ,\Varid{y2})),(\Varid{d},(\Varid{x2},\anonymous )))))\mathrel{=}(\Varid{avgColor},(((\Varid{x1}\mathbin{+}\Varid{x2})),((\Varid{y1}\mathbin{+}\Varid{y2})))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{avgColor}\mathrel{=}\Varid{a}\mbox{\onelinecomment  avgRGB (map outPixel [a,b,c,d])}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avgPixel2}\mathbin{::}[\mskip1.5mu (\Varid{a},(\Conid{Int},\Conid{Int}))\mskip1.5mu]\to (\Varid{a},(\Conid{Int},\Conid{Int})){}\<[E]%
\\
\>[B]{}\Varid{avgPixel2}\mathrel{=}\conj{\Varid{avgColor}}{\Varid{avgSize}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{avgColor}\mathrel{=}\p1\comp \Varid{head}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{avgSize}\mathrel{=}\conj{\Varid{divPair}\comp \conj{\p1\comp \p2}{\p1}}{\Varid{divPair}\comp \conj{\p2\comp \p2}{\p1}}\comp (\conj{\length }{\Varid{foldr}\;\Varid{addCell}\;(\mathrm{0},\mathrm{0})})\comp (\map \;\p2){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{divPair}\mathrel{=}\uncurry{\cdot \div \cdot }{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{addCell}\;(\Varid{x1},\Varid{y1})\;(\Varid{x2},\Varid{y2})\mathrel{=}(\Varid{x1}\mathbin{+}\Varid{x2},\Varid{y1}\mathbin{+}\Varid{y2}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pair2list}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}[\mskip1.5mu \Varid{a},\Varid{b},\Varid{c},\Varid{d}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avgRGB}\mathbin{::}[\mskip1.5mu (\Conid{Int},(\Conid{Int},(\Conid{Int},\Conid{Int})))\mskip1.5mu]\to (\Conid{Int},(\Conid{Int},(\Conid{Int},\Conid{Int}))){}\<[E]%
\\
\>[B]{}\Varid{avgRGB}\;\Varid{l}\mathrel{=}((\mathbin{\Varid{`div`}}\Varid{len})\times((\mathbin{\Varid{`div`}}\Varid{len})\times((\mathbin{\Varid{`div`}}\Varid{len})\times(\mathbin{\Varid{`div`}}\Varid{len}))))\;(\Varid{foldr}\;\Varid{suma}\;(\mathrm{0},(\mathrm{0},(\mathrm{0},\mathrm{0})))\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{len}\mathrel{=}\length \;\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{suma}\mathbin{::}(\Conid{Int},(\Conid{Int},(\Conid{Int},\Conid{Int})))\to (\Conid{Int},(\Conid{Int},(\Conid{Int},\Conid{Int})))\to (\Conid{Int},(\Conid{Int},(\Conid{Int},\Conid{Int}))){}\<[E]%
\\
\>[B]{}\Varid{suma}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\;(\Varid{a1},(\Varid{b1},(\Varid{c1},\Varid{d1})))\mathrel{=}(\Varid{a}\mathbin{+}\Varid{a1},(\Varid{b}\mathbin{+}\Varid{b1},(\Varid{c}\mathbin{+}\Varid{c1},\Varid{d}\mathbin{+}\Varid{d1}))){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  compressQTree = undefined}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{generatePTree}\mathrel{=}\Varid{anaFTree}\;(((\underline{\mathrm{1.0}}+\Varid{sqs}))\comp \Varid{outNat}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{sqs}\mathrel{=}\conj{\Varid{pitag}\comp \succ }{\Varid{dup}}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{pitag}\mathrel{=}\uncurry{(\mathbin{*})}\comp \conj{\Varid{pitagConst}}{\Varid{fromIntegral}}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{pitagConst}\mathrel{=}\underline{(\mathrm{2.0}\mathbin{*}(\Varid{sqrt}\;\mathrm{2.0}))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{drawPTree}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{picureTree}\mathbin{::}\Conid{PTree}\to \Conid{FTree}\;\Conid{Picture}\;\Conid{Picture}{}\<[E]%
\\
\>[B]{}\Varid{picureTree}\mathrel{=}\Varid{bimap}\;\Varid{mksquare}\;\Varid{mksquare}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{mksquare}\;\Varid{s}\mathrel{=}\mbox{\commentbegin Color black \commentend}(\Conid{Polygon}\;[\mskip1.5mu (\mathrm{0.0},\mathrm{0.0}),(\mathrm{0.0},\Varid{s}),(\Varid{s},\Varid{s}),(\Varid{s},\mathrm{0.0})\mskip1.5mu]){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
