...
\\[\blanklineskip]%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{flipCell}}{\Varid{flipTrees}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{compressQTree}\;\Varid{n}\;\Varid{t}\mathrel{=}\Varid{seek}\;((\Varid{depthQTree}\;\Varid{t})\mathbin{-}\Varid{n})\;\Varid{t}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
...
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{destroy}\mathbin{::}\Conid{QTree}\;\Varid{a}\to (\Varid{a},(\Conid{Int},\Conid{Int})){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
...
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{avgSize}\mathrel{=}\conj{\Varid{divP}\comp \conj{\p1\comp \p2}{\p1}}{\Varid{divP}\comp \conj{\p2\comp \p2}{\p1}}\comp (\conj{\length }{\Varid{foldr}\;\Varid{addP}\;(\mathrm{0},\mathrm{0})})\comp (\map \;\p2){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{divP}\mathrel{=}\uncurry{\cdot \div \cdot }{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{addP}\;(\Varid{x1},\Varid{y1})\;(\Varid{x2},\Varid{y2})\mathrel{=}(\Varid{x1}\mathbin{+}\Varid{x2},\Varid{y1}\mathbin{+}\Varid{y2}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{drawPTree}\mathrel{=}\Varid{cataFTree}\;\alt{\Varid{singl}}{\Varid{trans}}\comp \Varid{picureTree}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{trans}\mathbin{::}(\Conid{Picture},([\mskip1.5mu \Conid{Picture}\mskip1.5mu],[\mskip1.5mu \Conid{Picture}\mskip1.5mu]))\to [\mskip1.5mu \Conid{Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{trans}\;(\Varid{a},(\Varid{l},\Varid{r}))\mathrel{=}\Varid{a}\mathbin{:}\Varid{movel}\;\Varid{l}\plus \Varid{mover}\;\Varid{r}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{where}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{movel}\mathrel{=}\map \;(\lambda \Varid{h}\to \Conid{Rotate}\;\mathrm{45}\;(\Conid{Translate}\;(\mathbin{-}\Varid{halfA})\;(\Varid{halfA}\mathbin{+}\Varid{sqrt}\;((\Varid{width}\;\Varid{h})\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2})\;\Varid{h})){}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{mover}\mathrel{=}\map \;(\lambda \Varid{h}\to \Conid{Rotate}\;\mathrm{45}\;(\Conid{Translate}\;{}\<[59]%
\>[59]{}\Varid{halfA}\;{}\<[66]%
\>[66]{}(\Varid{halfA}\mathbin{+}\Varid{sqrt}\;((\Varid{width}\;\Varid{h})\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2})\;\Varid{h})){}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{halfA}\mathrel{=}((\Varid{width}\;\Varid{a})\mathbin{/}\mathrm{2.0}){}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{width}\;(\Conid{Polygon}\;(\anonymous \mathbin{:}\Varid{side}\mathbin{:}\Varid{t}))\mathrel{=}\Varid{abs}\;((\p1\;\Varid{side})\mathbin{-}(\p2\;\Varid{side})){}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{width}\;(\Conid{Translate}\;\anonymous \;\anonymous \;\Varid{p})\mathrel{=}\Varid{width}\;\Varid{p}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{width}\;(\Conid{Rotate}\;\anonymous \;\Varid{p})\mathrel{=}\Varid{width}\;\Varid{p}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{width}\;(\Conid{Pictures}\;(\Varid{h}\mathbin{:}\Varid{t}))\mathrel{=}\Varid{width}\;\Varid{h}{}\<[E]%
\\
\>[B]{}\mbox{\commentbegin 
flatMap (Polygon p) = p
flatMap (Translate x y (Pictures (h:t))) = Translate x y h : flatMap (Translate x y (Pictures t))
flatMap (Rotate a p) = \commentend}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{mksquare}\mathrel{=}\uncurry{\Varid{rectangleSolid}}\comp \Varid{dup}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
