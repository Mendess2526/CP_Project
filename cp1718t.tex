...
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{avgSize}\mathrel{=}\conj{\Varid{divP}\comp \conj{\p1}{\underline{\mathrm{2}}}}{\Varid{divP}\comp \conj{\p2}{\underline{\mathrm{2}}}}\comp (\Varid{foldr}\;\Varid{addP}\;(\mathrm{0},\mathrm{0}))\comp (\map \;\p2){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{divP}\mathrel{=}\Varid{floor}\comp \uncurry{(\mathbin{/})}\comp (\Varid{fromIntegral}\times\Varid{fromIntegral}){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
