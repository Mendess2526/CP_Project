...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inBlockchain}{}\<[23]%
\>[23]{}\mathrel{=}\alt{\Conid{Bc}}{\Conid{Bcs}}{}\<[E]%
\\
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bc}\;\Varid{a}){}\<[23]%
\>[23]{}\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bcs}\;\Varid{a})\mathrel{=}i_2\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{recBlockchain}\;\Varid{f}{}\<[23]%
\>[23]{}\mathrel{=}\Varid{id}+\Varid{id}\times\Varid{f}{}\<[E]%
\\
\>[B]{}\Varid{cataBlockchain}\;\Varid{g}{}\<[23]%
\>[23]{}\mathrel{=}\Varid{g}\comp \Varid{recBlockchain}\;(\Varid{cataBlockchain}\;\Varid{g})\comp \Varid{outBlockchain}{}\<[E]%
\\
\>[B]{}\Varid{anaBlockchain}\;\Varid{h}{}\<[23]%
\>[23]{}\mathrel{=}\Varid{inBlockchain}\comp \Varid{recBlockchain}\;(\Varid{anaBlockchain}\;\Varid{h})\comp \Varid{h}{}\<[E]%
\\
\>[B]{}\Varid{hyloBlockchain}\;\Varid{h}\;\Varid{g}{}\<[23]%
\>[23]{}\mathrel{=}\Varid{cataBlockchain}\;\Varid{h}\comp \Varid{anaBlockchain}\;\Varid{g}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{Block}\mathbin{+}\Conid{Block}\mathbin{*}\Conid{Blockchain}}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{normL}\mathrel{=}\cata{\alt{\Varid{nil}}{\Varid{nrm}}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{nrm}\;((\Varid{e},\Varid{v}),[\mskip1.5mu \mskip1.5mu]){}\<[36]%
\>[36]{}\mathrel{=}[\mskip1.5mu (\Varid{e},\Varid{v})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{nrm}\;((\Varid{e},\Varid{v}),((\Varid{el},\Varid{vl})\mathbin{:}\Varid{tl}))\mid \Varid{e}\equiv \Varid{el}{}\<[48]%
\>[48]{}\mathrel{=}(\Varid{el},\Varid{v}\mathbin{+}\Varid{vl})\mathbin{:}\Varid{tl}{}\<[E]%
\\
\>[9]{}\hsindent{27}{}\<[36]%
\>[36]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{el},\Varid{vl})\mathbin{:}(\Varid{nrm}\;((\Varid{e},\Varid{v}),\Varid{tl})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{t2l}\;(\Varid{f},(\Varid{v},\Varid{t}))\mathrel{=}[\mskip1.5mu (\Varid{f},\mathbin{-}\Varid{v}),(\Varid{t},\Varid{v})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{ledger}\mathrel{=}\Varid{normL}\comp \cata{\alt{\Varid{nil}}{\mathsf{conc}\comp (\Varid{t2l}\times\Varid{id})}}\comp \Varid{allTransactions}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=4cm{
    \ensuremath{\Conid{Blockchain}}
           \ar[d]_-{\ensuremath{\Varid{magic}\mathrel{=}\cata{\Varid{g}}}}
&
...
\\
     \ensuremath{[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]}
           \ar[d]_-{\ensuremath{\Varid{perfect}}}
&
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{magic}\mathrel{=}\Varid{cataBlockchain}\;\alt{\Varid{singl}\comp \p1}{\Varid{cons}\comp (\p1\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{perfect}\mathrel{=}\alt{\Varid{true}}{\Varid{and}\comp \Varid{cons}\comp \conj{\uncurry{\Varid{notElem}}}{\Varid{singl}\comp \Varid{perfect}\comp \p2}}\comp \Varid{outList}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\Varid{perfect}\comp \Varid{magic}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inQTree}\mathrel{=}\alt{\Varid{cell}}{\Varid{block}}{}\<[E]%
\\
\>[B]{}\Varid{cell}\;(\Varid{c},(\Varid{x},\Varid{y})){}\<[21]%
\>[21]{}\mathrel{=}\Conid{Cell}\;\Varid{c}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\Varid{block}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\
\>[B]{}\Varid{outQTree}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}){}\<[26]%
\>[26]{}\mathrel{=}i_1\;(\Varid{a},(\Varid{x},\Varid{y})){}\<[E]%
\\
...
\\
\>[B]{}\Varid{hyloQTree}\;\Varid{g}\;\Varid{f}\mathrel{=}\Varid{cataQTree}\;\Varid{g}\comp \Varid{anaQTree}\;\Varid{f}{}\<[E]%
\\[\blanklineskip]%
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{QTree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{rotateQTree}\mathrel{=}\cata{\Varid{g}}}}
&
    \ensuremath{(\Conid{A}\times(\Conid{Int}\times\Conid{Int}))\mathbin{+}(\Conid{A}\times(\Conid{Int},\Conid{Int}))\times(\Conid{QTree}\;\Conid{A})\;^4}
...
&
    \ensuremath{(\Conid{A}\times(\Conid{Int}\times\Conid{Int}))\mathbin{+}(\Conid{A}\times(\Conid{Int},\Conid{Int}))\times(\Conid{QTree}\;\Conid{A})\;^4}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{rotCell}}{\Varid{rotTrees}}}}
}
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{8}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{rotCell}}{\Varid{rotTrees}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\Varid{rotCell}\mathrel{=}\Varid{cell}\comp (\Varid{id}\times\Varid{swap}){}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\Varid{rotTrees}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}\Conid{Block}\;\Varid{c}\;\Varid{a}\;\Varid{d}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{QTree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{scaleQTree}\mathrel{=}\cata{\Varid{g}}}}
&
    \ensuremath{(\Conid{A}\times(\Conid{Int}\times\Conid{Int}))\mathbin{+}(\Conid{A}\times(\Conid{Int},\Conid{Int}))\times(\Conid{QTree}\;\Conid{A})\;^4}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\cata{\Varid{g}}\;^4}}
           \ar[l]_-{\ensuremath{\Varid{inQTree}}}
...
&
    \ensuremath{(\Conid{A}\times(\Conid{Int}\times\Conid{Int}))\mathbin{+}(\Conid{A}\times(\Conid{Int},\Conid{Int}))\times(\Conid{QTree}\;\Conid{A})\;^4}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{scaleCell}}{\Varid{block}}}}
}
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{scaleQTree}\;\Varid{s}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{scaleCell}}{\Varid{block}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{scaleCell}\mathrel{=}\Varid{cell}\comp (\Varid{id}\times((\Varid{s}\mathbin{*})\times(\Varid{s}\mathbin{*}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inPixel}\;(\Varid{r},(\Varid{g},(\Varid{b},\Varid{a})))\mathrel{=}\Conid{PixelRGBA8}\;\Varid{r}\;\Varid{g}\;\Varid{b}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outPixel}\;(\Conid{PixelRGBA8}\;\Varid{r}\;\Varid{g}\;\Varid{b}\;\Varid{a})\mathrel{=}(\Varid{r},(\Varid{g},(\Varid{b},\Varid{a}))){}\<[E]%
\\
\>[B]{}\Varid{invertQTree}\mathrel{=}\mathsf{fmap}\;(\Varid{inPixel}\comp ((\mathrm{255}\mathbin{-})\times((\mathrm{255}\mathbin{-})\times((\mathrm{255}\mathbin{-})\times\Varid{id})))\comp \Varid{outPixel}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{compressQTree}\;\Varid{n}\;\Varid{t}\mathrel{=}\Varid{anaQTree}\;(\Varid{seek}\comp \Varid{outP})\;((\Varid{depthQTree}\;\Varid{t})\mathbin{-}\Varid{n},\Varid{t})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{seek}\mathrel{=}(\alt{\Varid{destroy}\comp \p2}{\p2}+\Varid{spreadlove}){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{spreadlove}\;(\Varid{n},(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\mathrel{=}((\Varid{n},\Varid{a}),((\Varid{n},\Varid{b}),((\Varid{n},\Varid{c}),(\Varid{n},\Varid{d})))){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{outP}\;(\Varid{n},\Varid{a}){}\<[26]%
\>[26]{}\mid \Varid{n}\mathbin{<}\mathrm{1}\mathrel{=}i_1\;(i_1\;((),\Varid{a})){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{outP}\;(\Varid{n},(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})){}\<[34]%
\>[34]{}\mathrel{=}i_1\;(i_2\;(\Varid{n},(\Varid{a},(\Varid{x},\Varid{y})))){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{outP}\;(\Varid{n},(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}))\mathrel{=}i_2\;(\Varid{pred}\;\Varid{n},(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{destroy}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{id}}{\Varid{avgPixel}\comp \Varid{pair2list}}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{pair2list}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}[\mskip1.5mu \Varid{a},\Varid{b},\Varid{c},\Varid{d}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avgPixel}\mathrel{=}\conj{\Varid{avgColor}}{\Varid{avgSize}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{avgColor}\mathrel{=}\p1\comp \Varid{head}\mbox{\onelinecomment  escolhe a primeira porque não tenho maneira de fazer a media}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{avgSize}\mathrel{=}((\mathbin{\Varid{`div`}}\mathrm{2})\times(\mathbin{\Varid{`div`}}\mathrm{2}))\comp (\Varid{foldr}\;(\lambda (\Varid{x1},\Varid{y1})\;(\Varid{x2},\Varid{y2})\to (\Varid{x1}\mathbin{+}\Varid{x2},\Varid{y1}\mathbin{+}\Varid{y2}))\;(\mathrm{0},\mathrm{0}))\comp (\map \;\p2){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outlineQTree}\;\Varid{b}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{f}}{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{f}\;(\Varid{k},(\Varid{i},\Varid{j}))\mathrel{=}matrix\;\Varid{j}\;\Varid{i}\;(\mathbf{if}\;\Varid{b}\;\Varid{k}\;\mathbf{then}\;\Varid{outl}\;\Varid{j}\;\Varid{i}\;\mathbf{else}\;\Varid{false}){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{outl}\;\Varid{sx}\;\Varid{sy}\;(\Varid{x},\Varid{y})\mathrel{=}\Varid{x}\equiv \Varid{sx}\mathrel{\vee}\Varid{y}\equiv \Varid{sy}\mathrel{\vee}\Varid{x}\equiv \mathrm{1}\mathrel{\vee}\Varid{y}\equiv \mathrm{1}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{g}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{a}{\,\updownarrow\,}\Varid{b}){\,\leftrightarrow\,}(\Varid{c}{\,\updownarrow\,}\Varid{d}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
%
\just\equiv{ Fusão-\ensuremath{\mathbin{+}}, Natural-\ensuremath{\Varid{id}}, inNats, Eq+ }
%
...
%
\just\equiv{ Cancelamento+, \ensuremath{\Varid{m}\mathrel{=}\alt{\Varid{m1}}{\Varid{m2}}}, \ensuremath{\Varid{j}\mathrel{=}\alt{\Varid{j1}}{\Varid{j2}}} }
%
...
\ensuremath{\cata{\alt{\conj{\conj{\underline{\mathrm{1}}}{\succ \comp \underline{\Varid{k}}}}{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}}{\conj{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\conj{\Varid{mul}\comp \p2}{\cdot }}{\succ \comp \p2\comp \p2}}}}}
%
\just\equiv{\ensuremath{\mathsf{for}\ \Varid{b}\ \Varid{i}\mathrel{=}\cata{\alt{\underline{\Varid{i}}}{\Varid{b}}}}}
%
\ensuremath{\begin{lcbr}\Varid{i}\mathrel{=}\conj{\conj{\underline{\mathrm{1}}}{\succ \comp \underline{\Varid{k}}}}{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}\\\Varid{b}\mathrel{=}\conj{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\conj{\Varid{mul}\comp \p2}{\cdot }}{\succ \comp \p2\comp \p2}}\end{lcbr}}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inFTree}\mathrel{=}\alt{\Varid{unit}}{\Varid{comp}}{}\<[E]%
\\
\>[B]{}\Varid{unit}\mathrel{=}\Conid{Unit}{}\<[E]%
\\
\>[B]{}\Varid{comp}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\Conid{Comp}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{hyloFTree}\;\Varid{g}\;\Varid{f}\mathrel{=}\Varid{cataFTree}\;\Varid{g}\comp \Varid{anaFTree}\;\Varid{f}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{generatePTree}\mathrel{=}\Varid{anaFTree}\;(\Varid{seed}\comp \Varid{outP})\comp \conj{\Varid{id}}{\underline{\mathrm{1}}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{outP}\;(\mathrm{0},\Varid{s})\mathrel{=}i_1\;((),\Varid{s}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{outP}\;(\Varid{n},\Varid{s})\mathrel{=}i_2\;(\Varid{pred}\;\Varid{n},\Varid{s}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{seed}\mathrel{=}\p2+\conj{\p2}{\conj{\Varid{id}\times\Varid{pitag}}{\Varid{id}\times\Varid{pitag}}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{pitag}\mathrel{=}(((\Varid{sqrt}\;\mathrm{2})\mathbin{/}\mathrm{2})\mathbin{*}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{drawPTree}\mathrel{=}\Varid{cataFTree}\;\alt{\Varid{singl}\comp \Varid{mksquare}}{\Varid{trans}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{mksquare}\mathrel{=}\uncurry{\Varid{rectangleSolid}}\comp \Varid{dup}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{trans}\;(\Varid{a},(\Varid{l},\Varid{r}))\mathrel{=}\Varid{newRect}\mathbin{:}(\Varid{zipWith}\;(\lambda \Varid{b}\;\Varid{c}\to \Conid{Pictures}\;[\mskip1.5mu \Varid{newRect},\Varid{movel}\;\Varid{b},\Varid{mover}\;\Varid{c}\mskip1.5mu])\;\Varid{l}\;\Varid{r})\;\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{newRect}\mathrel{=}\Varid{mksquare}\;\Varid{a}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{movel}\mathrel{=}((\Conid{Translate}\;(\mathbin{-}(\Varid{a}\mathbin{/}\mathrm{2}))\;\Varid{a})\comp (\Conid{Rotate}\;(\mathbin{-}\mathrm{45}))){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{mover}\mathrel{=}((\Conid{Translate}\;{}\<[31]%
\>[31]{}(\Varid{a}\mathbin{/}\mathrm{2})\;{}\<[40]%
\>[40]{}\Varid{a})\comp (\Conid{Rotate}\;{}\<[53]%
\>[53]{}\mathrm{45})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\mu \mathrel{=}\mathit B\comp \Varid{concat}\comp (\mathsf{fmap}\;((\lambda (\Varid{a},\Varid{b})\to \map \;(\Varid{id}\times(\mathbin{*}\Varid{b}))\;\Varid{a})))\comp \Varid{unB}\comp (\mathsf{fmap}\;\Varid{unB}){}\<[E]%
\\
\>[B]{}\Varid{dist}\;\Varid{a}\mathrel{=}(\Conid{D}\comp (\mathsf{fmap}\;(\Varid{id}\times((\mathbin{/}\Varid{tot})\comp \Varid{fromIntegral})))\comp \Varid{unB})\;\Varid{a}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{tot}\mathrel{=}\Varid{fromIntegral}\mathbin{\$}\Varid{numberM}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{numberM}\mathrel{=}\cata{\alt{\underline{\mathrm{0}}}{\uncurry{(\mathbin{+})}\comp (\p2\times\Varid{id})}}\comp \Varid{unB}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
